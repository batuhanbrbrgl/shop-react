      ...
      <div className="w-full min-h-[150px] flex items-center gap-x-4">
        ...
        <div className="flex flex-col w-full">
          <div className="flex justify-between mb-2">
            <Link to={`/product/${id}`}>
              <h2 className="text-sm uppercase font-medium max-w-[240px] text-primary duration-300 hover:underline">
                {title}
              </h2>
            </Link>

            <div onClick={()=> removeFromCart(id)}  className="text-gray-500 text-xl cursor-pointer hover:text-red-500">
              <IoMdClose />
            </div>
          </div>
          <div className="font-semibold  flex gap-x-2 h-[36px] text-sm">
            ...
            <div className="flex-1 flex items-center justify-around text-primary font-medium">$ {price}</div>
